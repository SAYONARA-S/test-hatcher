...
//		switch (mType) {
//		case 0:
//			paint.setColor(mContext.getResources().getColor(R.color.nav_blue_bg));
//			break;
//		case 1:
//			paint.setColor(mContext.getResources().getColor(R.color.nav_red_bg));
//			break;
//		case 2:
//			paint.setColor(mContext.getResources().getColor(R.color.nav_green_bg));
//			break;
//		default:
//			break;
//		}
