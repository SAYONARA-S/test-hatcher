...
import com.hatcher.app.ui.fragment.BaseFragment;
 ...
 */
public class TeamSituationActivity extends BaseActivity implements View.OnClickListener, OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_situation);
        mContext = this;
        activity = this;
        ...
        CommonUtil.initViewInject(this, TeamSituationActivity.class, this);
    ...
    protected void initData() {
        imageLoader.displayImage("http://avatar.csdn.net/9/7/0/1_mosibi.jpg",team_icon,options);
    }
...
//			activity1 = (Activity) activity;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = inflater.inflate(R.layout.item_team_situation, null);
