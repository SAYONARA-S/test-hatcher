...
public class MyCompanyListActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mycompany_list);
        mContext = this;
        activity = this;
        loginConfig.loadConfig(this, Constants.LOGIN_CONFIG);
        CommonUtil.initViewInject(this, MyCompanyListActivity.class, this);
    ...
    protected void onClick(int viewId) {
        switch (viewId) {
            ...
            case R.id.search_layout:
                ...
                break;
            case R.id.apply:
                Intent intent = new Intent(mContext, ApplyCompanyActivity.class);
...
//                mHolder.my_info_des.setText(null);
            ...
            mHolder.item_info_layout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(mContext, CompanyFormActivity.class));
                }
            });
            return view;
        }
