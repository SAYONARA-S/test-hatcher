...
public class CompanyFormActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonUtil.initViewInject(this, CompanyFormActivity.class, this);
    ...
    protected void onClick(int viewId) {
        switch (viewId) {
            ...
            case R.id.my_situation_layout:
                startActivity(new Intent(mContext, CompanySituationActivity.class));
                break;
            case R.id.my_message_layout:

                break;
            case R.id.my_setting_layout:
                startActivity(new Intent(mContext, CompanySettingActivity.class));
                break;
