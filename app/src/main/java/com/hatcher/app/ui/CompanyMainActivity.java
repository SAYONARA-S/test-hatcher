...
public class CompanyMainActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonUtil.initViewInject(this, CompanyMainActivity.class, this);
    ...
    protected void onClick(int viewId) {
        switch (viewId) {
            case R.id.back_layout:
                ...
                break;
            case R.id.apply:
                startActivity(new Intent(mContext, ApplyCompanyActivity.class));
                break;
            case R.id.my_team_layout:
                startActivity(new Intent(mContext, MyCompanyListActivity.class));
                break;
