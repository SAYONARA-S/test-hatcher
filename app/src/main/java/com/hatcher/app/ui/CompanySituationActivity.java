 ...
 */
public class CompanySituationActivity extends BaseActivity implements View.OnClickListener, OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonUtil.initViewInject(this, CompanySituationActivity.class, this);
