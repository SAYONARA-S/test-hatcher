...
//    private List<View> viewContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonUtil.initViewInject(this, LoginActivity.class, this);
...
//    }
    ...
    private void userLogin() {
        ...
        HttpUtil.getExecutor().execute(new Runnable() {
            @Override
            public void run() {
                final LoginRspDTO rspDto = LoginService.userLogin(LoginActivity.this, userName, pwd);
//                final LoginRspDTO rspDto = null;
                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (rspDto == null) {
                            Toast.makeText(LoginActivity.this, getString(R.string.login_request_fail), Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if ("2000".equals(rspDto.getCode())) {
                            ...
                            Toast.makeText(LoginActivity.this, getString(R.string.login_request_fail), Toast.LENGTH_LONG).show();
                        }
