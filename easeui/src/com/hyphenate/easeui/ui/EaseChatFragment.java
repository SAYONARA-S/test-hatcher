...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected CallbackSendMsg callbackSendMsg;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        callbackSendMsg = (CallbackSendMsg)fragmentArgs.getSerializable("send_msg");
    ...
    protected void sendTextMessage(String content) {
        ...
        callbackSendMsg.sendMsgToLocalServer("text",content,null);
    ...
    protected void sendVoiceMessage(String filePath, int length) {
        ...
        sendMessage(message);
        callbackSendMsg.sendMsgToLocalServer("voice",null,filePath);
    }
    ...
    public interface CallbackSendMsg extends Serializable{
        public void sendMsgToLocalServer(String type,String content,String filepath);
    }
