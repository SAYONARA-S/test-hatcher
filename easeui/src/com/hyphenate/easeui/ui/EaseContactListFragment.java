...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
    	//to avoid crash when open com.hatcher.app after long time stay in background after user logged into another device
    ...
    protected void getContactList() {
        ...
        synchronized (this.contactsMap) {
            ...
            while (iterator.hasNext()) {
                ...
                // to make it compatible with data in previous version, you can remove this check if this is new com.hatcher.app
