...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    protected Handler micImageHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            micImage.setImageDrawable(micImages[(int)(msg.what/3 + 0.5)]);
        }
    };
    ...
    private void init(Context context) {
        ...
        micImages = new Drawable[] { getResources().getDrawable(R.drawable.chat_record_1),
                getResources().getDrawable(R.drawable.chat_record_2),
                getResources().getDrawable(R.drawable.chat_record_3),
                getResources().getDrawable(R.drawable.chat_record_4),
                getResources().getDrawable(R.drawable.chat_record_5)};
